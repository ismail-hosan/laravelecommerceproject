                    ...
                    <div class="col-lg-10">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form id="myForm" method="post" action="{{ route('admin.update.blog_post') }}"
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="form-group col-sm-9 text-secondary">
                                            <textarea name="post_short_description" class="form-control" id="inputProductDescription" rows="3">{{ $blogpost->post_short_desc }}</textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="form-group col-sm-9 text-secondary">
                                            <textarea name="post_long_description" class="form-control" id="mytextarea" rows="3">{{ $blogpost->post_long_desc }}</textarea>
                                        </div>
                                    </div>
