            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">New Blog Add</li>
                    </ol>
                </nav>
            </div>
        </div>
                    ...
                    <div class="col-lg-10">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form id="myForm" method="post" action="{{ route('banner.store.blog_post') }}" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row mb-3">
                                        <div class="col-sm-3">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="form-group col-sm-9 text-secondary">
                                            <textarea name="post_long_description" class="form-control" id="mytextarea" rows="3"></textarea>
                                        </div>
                                    </div>
