        ...
        <div class="container">
            <div class="main-body">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <form id="myForm"  action="{{route('admin.update.subcategory')}}" method="POST">
                                @csrf
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="form-group col-sm-9 text-secondary">
                                            <input type="text" name="subcategory_name" class="form-control" value="{{ $subcategorys->subcategory_name }}" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            <input type="submit" class="btn btn-primary px-4" value="Sub Category Update" />
                                        </div>
                                    </div>
                                </div>
                            </form>
