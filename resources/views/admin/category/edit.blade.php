        ...
        <div class="container">
            <div class="main-body">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <form id="myForm"  action="{{route('admin.update.category')}}" method="POST" enctype="multipart/form-data" >
                                @csrf
                                ...
                                <div class="card-body">
                                    <div class="row mb-3">
                                        ...
                                        <div class="form-group col-sm-9 text-secondary">
                                            <input type="text" name="Category_name" class="form-control" placeholder="Enter Your Slider Title" value="{{ $category->banner_title }}"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            <input type="submit" class="btn btn-primary px-4" value="Save Banner" />
                                        </div>
                                    </div>
                                </div>
                            </form>
