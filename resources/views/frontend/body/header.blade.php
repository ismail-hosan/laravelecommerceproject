            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-3 col-md-2 col-md-6 col-xs-6">
                        <a href="home-04.html" class="biolife-logo"><img src="{{asset('frontend/assets/images/organic-4.png')}}" alt="biolife logo" width="135" height="36"></a>
                    </div>
                                            ...
                                            <div class="col-lg-3 col-md-3 col-xs-12 md-margin-bottom-0 xs-margin-bottom-25">
                                                <div class="wrap-custom-menu vertical-menu">
                                                    ...
                                                    <ul class="menu">
                                                        ...
                                                        <li class="menu-item" ><a href="{{route('login')}}">Login/Register</a></li>
