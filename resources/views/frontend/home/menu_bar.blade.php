                                                                ...
                                                                <ul class="products-list default-product-style biolife-carousel nav-none-after-1k2 nav-center" data-slick='{"rows":1,"arrows":true,"dots":false,"infinite":false,"speed":400,"slidesMargin":30,"slidesToShow":1, "responsive":[{"breakpoint":767, "settings":{ "arrows": false}}]}' >
                                                                    ...
                                                                    <li class="product-item">
                                                                        <div class="contain-product none-overlay">
                                                                            <div class="product-thumb">
                                                                                <a href="#" class="link-to-product">
                                                                                    <img src="{{asset('frontend/assets/images/products/p-11.jpg')}}" alt="dd" width="270" height="270" class="product-thumnail">
                                                                                </a>
                                                                            </div>
                                                                            <div class="info">
                                                                                <b class="categories">Fresh Fruit</b>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-12 col-md-12 col-sm-12 md-margin-top-9">
                                                            <div class="biolife-brand" >
                                                                <ul class="brands">
                                                                    <li><a href="#"><img src="{{asset('frontend/assets/images/megamenu/brand-organic.png')}}" width="161" height="136" alt="organic"></a></li>
                                                                    <li><a href="#"><img src="{{asset('frontend/assets/images/megamenu/brand-explore.png')}}" width="160" height="136" alt="explore"></a></li>
                                                                    <li><a href="#"><img src="{{asset('frontend/assets/images/megamenu/brand-organic-2.png')}}" width="99" height="136" alt="organic 2"></a></li>
                                                                    <li><a href="#"><img src="{{asset('frontend/assets/images/megamenu/brand-eco-teas.png')}}" width="164"  height="136" alt="eco teas"></a></li>
                                                                </ul>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-5 col-md-4 col-sm-12 lg-padding-left-57 md-margin-bottom-30">
                                                            <div class="biolife-brand vertical md-boder-left-30">
                                                                ...
                                                                <ul class="brands">
                                                                    <li><a href="#"><img src="{{asset('frontend/assets/images/megamenu/v-brand-organic.png')}}" width="167" height="74" alt="organic"></a></li>
                                                                    <li><a href="#"><img src="{{asset('frontend/assets/images/megamenu/v-brand-explore.png')}}" width="167" height="72" alt="explore"></a></li>
                                                                    <li><a href="#"><img src="{{asset('frontend/assets/images/megamenu/v-brand-organic-2.png')}}" width="167" height="99" alt="organic 2"></a></li>
                                                                    <li><a href="#"><img src="{{asset('frontend/assets/images/megamenu/v-brand-eco-teas.png')}}" width="167" height="67" alt="eco teas"></a></li>
                                                                </ul>
                                                            </div>
                                                        </div>
                                                    </div>
                            ...
                            @foreach ($slider as $slider)
                                <li>
                                    <div class="slide-contain slider-opt04__layout01">
                                        <div class="media" style="background-image: url({{ asset($slider->slider_image) }});"></div>
